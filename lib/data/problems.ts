...
import abstractAlgebraCosets1 from '@/public/problems/abstract-algebra-cosets-1.json';
...
import algebraAbsoluteValue1 from '@/public/problems/algebra-absolute-value-1.json';
import algebraComplexNumbers1 from '@/public/problems/algebra-complex-numbers-1.json';
import algebraExponentRules1 from '@/public/problems/algebra-exponent-rules-1.json';
import algebraExponentRules2 from '@/public/problems/algebra-exponent-rules-2.json';
import algebraInequalities1 from '@/public/problems/algebra-inequalities-1.json';
...
import algebraRationalExpressions1 from '@/public/problems/algebra-rational-expressions-1.json';
...
import calculusContinuity1 from '@/public/problems/calculus-continuity-1.json';
import calculusDerivativeDefinition1 from '@/public/problems/calculus-derivative-definition-1.json';
import calculusExtrema1 from '@/public/problems/calculus-extrema-1.json';
...
import calculusPolarCoordinates1 from '@/public/problems/calculus-polar-coordinates-1.json';
...
import calculusSqueezeTheorem1 from '@/public/problems/calculus-squeeze-theorem-1.json';
...
import complexAnalysisHarmonicFunctions1 from '@/public/problems/complex-analysis-harmonic-functions-1.json';
import complexAnalysisLaurentSeries1 from '@/public/problems/complex-analysis-laurent-series-1.json';
import complexAnalysisLineIntegrals1 from '@/public/problems/complex-analysis-line-integrals-1.json';
...
import differentialEquationsExactEquations1 from '@/public/problems/differential-equations-exact-equations-1.json';
...
import differentialEquationsLinearSystems1 from '@/public/problems/differential-equations-linear-systems-1.json';
...
import discreteMathGraphIsomorphism1 from '@/public/problems/discrete-math-graph-isomorphism-1.json';
...
import discreteMathTrees1 from '@/public/problems/discrete-math-trees-1.json';
import geometryAreaFormulas1 from '@/public/problems/geometry-area-formulas-1.json';
import geometryConicSections1 from '@/public/problems/geometry-conic-sections-1.json';
...
import geometryVectors1 from '@/public/problems/geometry-vectors-1.json';
...
import linearAlgebraChangeOfBasis1 from '@/public/problems/linear-algebra-change-of-basis-1.json';
...
import linearAlgebraInnerProducts1 from '@/public/problems/linear-algebra-inner-products-1.json';
...
import linearAlgebraProjection1 from '@/public/problems/linear-algebra-projection-1.json';
import linearAlgebraQrDecomposition1 from '@/public/problems/linear-algebra-qr-decomposition-1.json';
import linearAlgebraRankNullity1 from '@/public/problems/linear-algebra-rank-nullity-1.json';
...
import multivariableCurlDivergence1 from '@/public/problems/multivariable-curl-divergence-1.json';
...
import multivariableGradient1 from '@/public/problems/multivariable-gradient-1.json';
...
import numberTheoryCongruences1 from '@/public/problems/number-theory-congruences-1.json';
...
import numberTheoryGreatestCommonDivisor1 from '@/public/problems/number-theory-greatest-common-divisor-1.json';
...
import numberTheoryPerfectNumbers1 from '@/public/problems/number-theory-perfect-numbers-1.json';
...
import probabilityBinomialDistribution1 from '@/public/problems/probability-binomial-distribution-1.json';
...
import probabilityIndependence1 from '@/public/problems/probability-independence-1.json';
...
import probabilityPoissonDistribution1 from '@/public/problems/probability-poisson-distribution-1.json';
import probabilityRandomVariables1 from '@/public/problems/probability-random-variables-1.json';
import probabilityVariance1 from '@/public/problems/probability-variance-1.json';
...
import realAnalysisCompleteness1 from '@/public/problems/real-analysis-completeness-1.json';
...
import realAnalysisMetricSpaces1 from '@/public/problems/real-analysis-metric-spaces-1.json';
...
import realAnalysisSequences1 from '@/public/problems/real-analysis-sequences-1.json';
...
import topologyContinuousMaps1 from '@/public/problems/topology-continuous-maps-1.json';
import topologyFundamentalGroup1 from '@/public/problems/topology-fundamental-group-1.json';
...
export const PROBLEM_DB: Record<string, Problem> = {
  'abstract-algebra-cosets-1': abstractAlgebraCosets1 as any as Problem,
  ...
  'algebra-absolute-value-1': algebraAbsoluteValue1 as any as Problem,
  'algebra-complex-numbers-1': algebraComplexNumbers1 as any as Problem,
  'algebra-exponent-rules-1': algebraExponentRules1 as any as Problem,
  'algebra-exponent-rules-2': algebraExponentRules2 as any as Problem,
  'algebra-inequalities-1': algebraInequalities1 as any as Problem,
  ...
  'algebra-quadratic-1': algebraQuadratic1 as any as Problem,
  'algebra-rational-expressions-1': algebraRationalExpressions1 as any as Problem,
  'algebra-systems-linear-1': algebraSystemsLinear1 as any as Problem,
  'algebra-vietas-formulas-1': algebraVietasFormulas1 as any as Problem,
  'calc-derivative-chain-rule-1': calcDerivativeChainRule1 as any as Problem,
  ...
  'calculus-continuity-1': calculusContinuity1 as any as Problem,
  'calculus-derivative-definition-1': calculusDerivativeDefinition1 as any as Problem,
  'calculus-extrema-1': calculusExtrema1 as any as Problem,
  ...
  'calculus-integration-substitution-1': calculusIntegrationSubstitution1 as any as Problem,
  ...
  'calculus-limit-epsilon-delta-1': calculusLimitEpsilonDelta1 as any as Problem,
  ...
  'calculus-polar-coordinates-1': calculusPolarCoordinates1 as any as Problem,
  ...
  'calculus-squeeze-theorem-1': calculusSqueezeTheorem1 as any as Problem,
  ...
  'complex-analysis-harmonic-functions-1': complexAnalysisHarmonicFunctions1 as any as Problem,
  'complex-analysis-laurent-series-1': complexAnalysisLaurentSeries1 as any as Problem,
  'complex-analysis-line-integrals-1': complexAnalysisLineIntegrals1 as any as Problem,
  ...
  'differential-equations-exact-equations-1': differentialEquationsExactEquations1 as any as Problem,
  ...
  'differential-equations-linear-systems-1': differentialEquationsLinearSystems1 as any as Problem,
  ...
  'discrete-math-graph-isomorphism-1': discreteMathGraphIsomorphism1 as any as Problem,
  ...
  'discrete-math-trees-1': discreteMathTrees1 as any as Problem,
  'geometry-area-formulas-1': geometryAreaFormulas1 as any as Problem,
  'geometry-conic-sections-1': geometryConicSections1 as any as Problem,
  ...
  'geometry-pythagorean-proof-1': geometryPythagoreanProof1 as any as Problem,
  'geometry-similar-triangles-1': geometrySimilarTriangles1 as any as Problem,
  'geometry-triangle-angles-1': geometryTriangleAngles1 as any as Problem,
  'geometry-triangle-centers-1': geometryTriangleCenters1 as any as Problem,
  'geometry-vectors-1': geometryVectors1 as any as Problem,
  ...
  'linear-algebra-change-of-basis-1': linearAlgebraChangeOfBasis1 as any as Problem,
  ...
  'linear-algebra-inner-products-1': linearAlgebraInnerProducts1 as any as Problem,
  ...
  'linear-algebra-projection-1': linearAlgebraProjection1 as any as Problem,
  'linear-algebra-qr-decomposition-1': linearAlgebraQrDecomposition1 as any as Problem,
  'linear-algebra-rank-nullity-1': linearAlgebraRankNullity1 as any as Problem,
  ...
  'logic-proof-contradiction-1': logicProofContradiction1 as any as Problem,
  ...
  'multivariable-curl-divergence-1': multivariableCurlDivergence1 as any as Problem,
  ...
  'multivariable-gradient-1': multivariableGradient1 as any as Problem,
  ...
  'number-theory-congruences-1': numberTheoryCongruences1 as any as Problem,
  'number-theory-divisibility-1': numberTheoryDivisibility1 as any as Problem,
  ...
  'number-theory-gcd-1': numberTheoryGcd1 as any as Problem,
  'number-theory-greatest-common-divisor-1': numberTheoryGreatestCommonDivisor1 as any as Problem,
  ...
  'number-theory-perfect-numbers-1': numberTheoryPerfectNumbers1 as any as Problem,
  ...
  'probability-binomial-distribution-1': probabilityBinomialDistribution1 as any as Problem,
  ...
  'probability-independence-1': probabilityIndependence1 as any as Problem,
  ...
  'probability-poisson-distribution-1': probabilityPoissonDistribution1 as any as Problem,
  'probability-random-variables-1': probabilityRandomVariables1 as any as Problem,
  'probability-variance-1': probabilityVariance1 as any as Problem,
  ...
  'real-analysis-completeness-1': realAnalysisCompleteness1 as any as Problem,
  ...
  'real-analysis-metric-spaces-1': realAnalysisMetricSpaces1 as any as Problem,
  ...
  'real-analysis-sequences-1': realAnalysisSequences1 as any as Problem,
  ...
  'topology-continuous-maps-1': topologyContinuousMaps1 as any as Problem,
  'topology-fundamental-group-1': topologyFundamentalGroup1 as any as Problem,
